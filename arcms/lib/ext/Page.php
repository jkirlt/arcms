...
//        'theme' => '%HEADER% %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%', // 显示共有好多数据
    ...
    public function __construct($totalRows, $listRows, $urlParams = '')
    {
        ...
        $this->nowPage = (!\ar\core\request($this->p) || \ar\core\request($this->p) < 1) ? 1 : intval(\ar\core\request($this->p));
    ...
    {
        return \ar\core\url('', array('page' => $page, 'greedyUrl' => true));
