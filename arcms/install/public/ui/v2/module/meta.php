...
<meta name="generator" content="智数 {$_M[config][metcms_v]}" data-variable="{$_M['url']['site']}|{$lang}|{$classnow}|{$id}|{$class_list[$classnow][module]}|{$_M[config][met_skin_user]}"{$user_name}/>
